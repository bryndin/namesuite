...
def patch_gramps_constants():
    with patch(
        "NameSuite.name_processor.repositories.gramps_write.NameOriginType", MockNameOriginType
    ):
        yield
...
@patch("NameSuite.name_processor.repositories.gramps_write.update_or_add_patronymic")
